...
{
    ReplicationActorList.Reset(GRepActorsNumPerHex);
}
...
FORCEINLINE void UReplicationGraphNode_HexCell::AddDynamicActor(const FNewReplicatedActorInfo& ActorInfo)
{
    //UE_LOG( LogHexRepGraph, Display, TEXT( __FUNCTION__ ) );
...
FORCEINLINE void UReplicationGraphNode_HexCell::RemoveStaticActor(const FNewReplicatedActorInfo& ActorInfo, FGlobalActorReplicationInfo& ActorRepInfo, bool bWasAddedAsDormantActor)
{
    UE_LOG(LogHexRepGraph, Display, TEXT( __FUNCTION__ ));
...
FORCEINLINE void UReplicationGraphNode_HexCell::RemoveDynamicActor(const FNewReplicatedActorInfo& actorInfo)
{
    //UE_LOG( LogHexRepGraph, Display, TEXT( __FUNCTION__ ) );
...
FORCEINLINE UReplicationGraphNode_DormancyNode* UReplicationGraphNode_HexCell::GetDormancyNode()
{
...
FORCEINLINE UReplicationGraphNode* UReplicationGraphNode_HexCell::GetDynamicNode()
{
